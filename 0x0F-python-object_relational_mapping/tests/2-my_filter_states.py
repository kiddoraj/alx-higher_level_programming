...
import io
import find_state  # Import the script to be tested

class TestFindStateScript(unittest.TestCase):

    @patch('sys.argv', ['find_state.py', 'test_user', 'test_password', 'test_db', 'California'])
